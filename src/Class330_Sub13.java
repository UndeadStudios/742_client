...
public class Class330_Sub13 extends Class330
{
	...
	if (i != 0 || i_0_ != 0) {
	    if (anIntArray7600 == null
		|| (anIntArray7600.length
		    != ((Class330_Sub13) this).anIntArray7603.length))
		anIntArray7600
		    = new int[((Class330_Sub13) this).anIntArray7603.length];
	    ...
	    for (int i_6_ = 0; i_6_ < i_1_;
		 i_6_ += ((Class330_Sub13) this).anInt7599) {
		int i_7_ = i_6_ + i_4_ & i_5_;
		for (int i_8_ = 0; i_8_ < ((Class330_Sub13) this).anInt7599;
		     i_8_++) {
		    int i_9_ = i_6_ + i_8_;
		    int i_10_ = i_7_ + (i_8_ + i_2_ & i_3_);
		    anIntArray7600[i_9_]
			= ((Class330_Sub13) this).anIntArray7603[i_10_];
		}
	    }
	...
	if (bool) {
		...
		for (int i_24_ = i_18_; i_24_ >= 0; i_24_--) {
		    int i_25_
			= ((Class330_Sub13) this).anIntArray7603[--i_22_];
		...
		for (int i_40_ = i_18_; i_40_ >= 0; i_40_--) {
			...
			= ((Class330_Sub13) this).anIntArray7603[--i_22_];
		    int i_42_
			= ((Class330_Sub13) this).anIntArray7603[--i_21_];
		    is_12_[i_40_]
